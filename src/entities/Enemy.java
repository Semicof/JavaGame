...
public abstract class Enemy extends Entity{
    protected int aniIndex,enemyState,enemyType,aniTick,aniSpeed=25,walkDir=LEFT,tileY;
    protected boolean firstUpdate=true,inAir=false;
    protected float fallSpeed,gravity=0.04f* Game.SCALE,walkSpeed=0.5f*Game.SCALE,attackDistance=Game.TILES_SIZE;
